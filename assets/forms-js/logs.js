...
>>>>>>> f046b9342a25b36d63551fd120291caefbe59f18
    });
  });
...
>>>>>>> f046b9342a25b36d63551fd120291caefbe59f18
  ...
  $("#add-sub-assignee").on("click", function () {
    ...
    if (!userIds || userIds.length === 0) {
      showAlert(
        "Please select at least one sub-assignee.",
        "danger",
        "subassignee-alert-container"
      );
      return;
